...
Scribe is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
Usage analytics is optional and off by default. When you choose to enable it, Scribe collects minimal, anonymized usage data:
...
Scribe is a fork of the open-source [Meetily](https://github.com/Zackriya-Solutions/meeting-minutes) project, repackaged as [Scribe](https://github.com/Bobarinn/scribe) by [Kolade Abobarin](https://github.com/Bobarinn/).

---

*This privacy policy applies to Scribe (forked from Meetily v0.0.5) and later versions. For enterprise deployments, additional privacy controls may be available.*
