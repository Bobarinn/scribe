@echo off
REM Scribe Build Script for Windows
...
echo 🚀 Building Scribe application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Scribe Tauri application for Windows.
