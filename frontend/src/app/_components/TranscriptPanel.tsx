...
export function TranscriptPanel({
  ...
  return (
    <div ref={transcriptContainerRef} className="w-full border-r border-gray-200 bg-white flex flex-col overflow-y-auto">
      {/* Title area - Sticky header (empty space doubles as a Tauri drag region) */}
      <div data-app-drag className="sticky top-0 z-10 bg-white p-4 pl-12 border-gray-200">
        <div data-app-drag className="flex flex-col space-y-3">
