    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                <div className="mb-3">
                    <Image
                        src="/brand/png/app-icon-rounded/app-icon-192.png"
                        alt="Scribe"
                        width={72}
                        height={72}
                ...
                <h1 className="text-xl font-bold text-brand-ink tracking-tight">Scribe</h1>
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-brand-ink">What makes Scribe different</h2>
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-brand-body/60 rounded-xl p-3 hover:bg-brand-eraser/50 transition-colors">
                        <h3 className="font-bold text-sm text-brand-ink mb-1">Privacy-first</h3>
                    ...
                    <div className="bg-brand-body/60 rounded-xl p-3 hover:bg-brand-eraser/50 transition-colors">
                        <h3 className="font-bold text-sm text-brand-ink mb-1">Use Any Model</h3>
                    ...
                    <div className="bg-brand-body/60 rounded-xl p-3 hover:bg-brand-eraser/50 transition-colors">
                        <h3 className="font-bold text-sm text-brand-ink mb-1">Cost-Smart</h3>
                    ...
                    <div className="bg-brand-body/60 rounded-xl p-3 hover:bg-brand-eraser/50 transition-colors">
                        <h3 className="font-bold text-sm text-brand-ink mb-1">Works everywhere</h3>
            ...
            {/* Coming Soon - Compact */}
            <div className="bg-brand-eraser rounded-xl p-3">
                <p className="text-s text-brand-graphite">
                    <span className="font-bold text-brand-ink">Coming soon:</span> A library of on-device AI agents-automating follow-ups, action tracking, and more.
                </p>
            </div>

            {/* CTA Section - Compact */}
            <div className="text-center space-y-2">
                <h3 className="text-medium font-semibold text-brand-ink">Ready to push your business further?</h3>
                ...
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md"
                >
