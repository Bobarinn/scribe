...
export function HomebrewDatabaseDetector({ onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  return (
    <div className="mb-4 p-4 bg-brand-eraser border-2 border-primary/40 rounded-lg">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-brand-graphite mb-2">
          ...
          <p className="text-sm text-brand-graphite mb-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-primary/70 text-primary rounded-lg hover:bg-brand-eraser disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
